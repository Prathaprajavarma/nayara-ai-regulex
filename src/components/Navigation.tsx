      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-coral to-gold">
                NAYARAi
              </div>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link to="/about" className="text-foreground hover:text-coral transition-colors">
              About
            </Link>
            <Link to="/services" className="text-foreground hover:text-coral transition-colors">
              Services
            </Link>
            <Link to="/product" className="text-foreground hover:text-coral transition-colors">
              Product
            </Link>
